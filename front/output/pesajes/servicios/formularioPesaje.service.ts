/**
 * @fileoverview Servicio FormularioPesaje, clase encargada de la comunicacion con el BackEnd
 *
 * @version             1.0
 *
 ...
 * ----
 * La primera versión de FormularioPesajeService fue escrita por Dyson Arley Parra Tilano.
 */
