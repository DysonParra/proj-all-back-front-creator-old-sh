/**
 * @fileoverview FormularioPesajeState, clase encargada de la de estados en los datos obtenidos desde el BackEnd
 *
 * @version             1.0
 *
 ...
 * La primera versión de FormularioPesajeState fue escrita por Dyson A. Parra T.
 */
